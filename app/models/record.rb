class Record < ActiveRecord::Base
  ...
  def categoy_belongs_to_user
    ...
    category = true if self.category == 'SYSTEM'  # bypass when it is generated by the sysetm. 
    if(!category)
      errors.add(:category, " must belongs to the user.")
    end
  end
  ...
  def category_type_fits_in_out_payment
    ...
    elsif (self.category == 'SYSTEM')  # bypass when it is generated by the sysetm. 
    else
      errors.add(:category, " type must fit in & out payment.")
    end
  end
  ...
  def subcategory_belongs_to_category
    ...
    if ( (category != category_find_by_subcategory) && (self.category != 'SYSTEM') )
      errors.add(:subcategory, " must belongs to the user.")
    end
  end
  ...
  def only_transfer_has_in_amount_currecny
    ...
    if    (  is_transfer &&  has_in_amount &&  has_in_currency )
      ...
      errors.add(:in_amount, "; Only transfer has in_amount & in_currency.")
    end
  end
  ...
  def transfer_in_payment_out_payment_are_different
    ...
    if(is_transfer && (self.in_payment==self.out_payment))
      errors.add(:in_payment, "; Transfer has different in_payment & out_payment.")
    end
  end
