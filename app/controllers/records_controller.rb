class RecordsController < ApplicationController
  ...
  def new
    ...
    @income_category = Category.where(user_id: current_user.id,type: 10, hash_key:Subcategory.select("id_category").where(user_id: current_user.id)).not_hidden.each_slice(3).to_a
