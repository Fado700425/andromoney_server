...
ActiveRecord::Schema.define(version: 20150829142046) do
  ...
  add_index "announcements", ["category", "created_at"], name: "index_announcements_on_category_and_created_at"
  add_index "announcements", ["locale", "created_at"], name: "index_announcements_on_locale_and_created_at"
  ...
  create_table "record_table", force: true do |t|
    ...
    t.float    "location_long",     limit: 25
    t.float    "location_latitude", limit: 25
    t.integer  "quantity"
  end
