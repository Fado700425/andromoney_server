...
describe Api::V1::SyncController do
  ...
  context "Post start" do
    ...
    context "with valid inputs" do
      ...
      #   post :start, {body: {user: user.email,device: device.uuid}}
      ...
      #   post :start, {body: {user: user.email,device: device1.uuid}}
      #   post :start, {body: {user: user.email,device: device2.uuid}}
  ...
  #       post :end, {body: {user: user.email,device: device.uuid}}
  ...
  #       device2 = Fabricate(:device, user_id: user.id)
  #       post :end, {body: {user: user.email,device: device2.uuid}}
  #       response.response_code.should == 403
  #     end
  #   end
  ...
  #   context "with invalid inputs" do
  #     it "return status 404" do
  #       post :end, {body: {user: "test",device: "fake_id"}}
  #       response.response_code.should == 404
  #     end
  #   end
  # end
