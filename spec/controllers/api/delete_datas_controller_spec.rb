  ...
  describe "Delete destroy" do
    ...
    context "with valid input" do
      ...
      it "do not delete the record data which not belong to the user" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, record_table: [{hash_key: record1.hash_key, update_time: Time.now},{hash_key: record2.hash_key, update_time: Time.now}]}
        expect(record1.reload.is_delete).to be_truthy
        expect(record2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the category data" do
        ...
        expect(category2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the payee data" do
        ...
        expect(payee1.reload.is_delete).to be_truthy
        expect(payee2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the currency data" do
        ...
        expect(currency1.reload.is_delete).to be_truthy
        expect(currency2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the payment data" do
        ...
        expect(payment1.reload.is_delete).to be_truthy
        expect(payment2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the period data" do
        ...
        expect(period1.reload.is_delete).to be_truthy
        expect(period2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the pref data" do
        ...
        expect(pref1.reload.is_delete).to be_truthy
        expect(pref2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the project data" do
        ...
        expect(project1.reload.is_delete).to be_truthy
        expect(project2.reload.is_delete).to be_falsy
      end
      ...
      it "delete the subcategory data" do
        ...
        expect(subcategory1.reload.is_delete).to be_truthy
        expect(subcategory2.reload.is_delete).to be_falsy
      end
    ...
    context "with invalid input" do
      ...
      it "do not delete data" do
        ...
        expect(record1.reload.is_delete).to be_falsy
        expect(record2.reload.is_delete).to be_falsy
      end
    end
