  ...
  describe "Delete destroy" do
    ...
    context "with valid input" do
      ...
      it "update the record data" do
        ...
        post :update_all, {id: user1.email,device: device.uuid, records: [{hash_key: record1.hash_key, amount_to_main: 50.5},{hash_key: record2.hash_key, amount_to_main: 50.5}]}
      ...
      it "update the category data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, categories: [{hash_key: category1.hash_key, category: "BestFood"},{hash_key: category2.hash_key, category: "BestFood"}]}
      ...
      it "update the payee data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, payees: [{hash_key: payee1.hash_key,payee_name: "Mary"},{hash_key: payee2.hash_key,payee_name: "Mary"}]}
      ...
      it "update the currency data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, currencies: [{currency_code: currency1.currency_code, rate: 3.9},{currency_code: currency2.currency_code,rate: 3.9}]}
      ...
      it "update the payment data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, payments: [{hash_key: payment1.hash_key, payment_name: "Bank"},{hash_key: payment2.hash_key, payment_name: "Bank"}]}
      ...
      it "update the period data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, periods: [{hash_key: period1.hash_key, preriod_num: 1},{hash_key: period2.hash_key, preriod_num: 1}]}
      ...
      it "update the pref data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, prefs: [{key: pref1.key,value: "b"},{key: pref2.key,value: "b"}]}
      ...
      it "update the project data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, projects: [{hash_key: project1.hash_key, project_name: "Fat"},{hash_key: project2.hash_key, project_name: "Fat"}]}
      ...
      it "update the subcategory data" do
        ...
        post :update_all, {id: user1.email, device: device.uuid, subcategories: [{hash_key: subcategory1.hash_key, subcategory: "shoe"},{hash_key: subcategory2.hash_key, subcategory: "shoe"}]}
    ...
    context "with invalid input" do
      ...
      it "do not update data" do
        ...
        post :update_all, {id: "bad_id",device: device.uuid, records: [{hash_key: record1.hash_key, amount_to_main: 50.5},{hash_key: record2.hash_key, amount_to_main: 50.5}]}
