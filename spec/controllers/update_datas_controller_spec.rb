    ...
    context "with valid input" do
      ...
      context "update_time is out of date" do
        it "only update the record data which update_time is newer" do
          ...
          post :update_all, body: {user: user1.email,device: device.uuid, record_table: [{hash_key: record1.hash_key, amount_to_main: 50.5,update_time: Time.now - 2.hour },{hash_key: record2.hash_key, amount_to_main: 50.5,update_time: Time.now}]}.to_json
      ...
      context "update_time is newer" do
        ...
        it "update the record data" do
          ...
          record1 = Fabricate(:record, user_id: user1.id, amount_to_main: 25, update_time: Time.now - 1.hour)
          record2 = Fabricate(:record, user_id: user1.id, amount_to_main: 25, update_time: Time.now - 1.hour)
          post :update_all, body: {user: user1.email,device: device.uuid, record_table: [{hash_key: record1.hash_key, amount_to_main: 50.5,update_time: Time.now},{hash_key: record2.hash_key, amount_to_main: 50.5,update_time: Time.now}]}.to_json
        ...
        it "update the category data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, category_table: [{hash_key: category1.hash_key, category: "BestFood", update_time: Time.now},{hash_key: category2.hash_key, category: "BestFood", update_time: Time.now}]}.to_json
        ...
        it "update the payee data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, payee_table: [{hash_key: payee1.hash_key,payee_name: "Mary", update_time: Time.now},{hash_key: payee2.hash_key,payee_name: "Mary", update_time: Time.now}]}.to_json
        ...
        it "update the currency data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, currency_table: [{currency_code: currency1.currency_code, rate: 3.9, update_time: Time.now},{currency_code: currency2.currency_code,rate: 3.9, update_time: Time.now}]}.to_json
        ...
        it "update the payment data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, payment_table: [{hash_key: payment1.hash_key, payment_name: "Bank", update_time: Time.now},{hash_key: payment2.hash_key, payment_name: "Bank", update_time: Time.now}]}.to_json
        ...
        it "update the period data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, period_table: [{hash_key: period1.hash_key, period_num: 1, update_time: Time.now},{hash_key: period2.hash_key, period_num: 1, update_time: Time.now}]}.to_json
        ...
        it "update the pref data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, pref_table: [{key: pref1.key,value: "b", update_time: Time.now},{key: pref2.key,value: "b", update_time: Time.now}]}.to_json
        ...
        it "update the project data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, project_table: [{hash_key: project1.hash_key, project_name: "Fat", update_time: Time.now},{hash_key: project2.hash_key, project_name: "Fat", update_time: Time.now}]}.to_json
        ...
        it "update the subcategory data" do
          ...
          post :update_all, body: {user: user1.email, device: device.uuid, subcategory_table: [{hash_key: subcategory1.hash_key, subcategory: "shoe", update_time: Time.now},{hash_key: subcategory2.hash_key, subcategory: "shoe", update_time: Time.now}]}.to_json
