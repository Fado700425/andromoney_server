...
describe Api::V1::DeleteDatasController do
  ...
  describe "Delete destroy" do
    ...
    context "with valid input" do
      ...
      #   post :delete_all, body: {user: Faker::Internet.email, device: Faker::Lorem.characters(20), record_table: [{hash_key: Faker::Lorem.characters(20)},{hash_key: Faker::Lorem.characters(20)}]}
      ...
      it "update device sync_start_time before sync" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, record_table: [{hash_key: record1.hash_key},{hash_key: record2.hash_key}]}
      ...
      it "delete the category data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, category_table: [{hash_key: category1.hash_key},{hash_key: category2.hash_key}]}
      ...
      it "delete the payee data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, payee_table: [{hash_key: payee1.hash_key},{hash_key: payee2.hash_key}]}
      ...
      it "delete the currency data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, currency_table: [{currency_code: currency1.currency_code},{currency_code: currency2.currency_code}]}
      ...
      it "delete the payment data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, payment_table: [{hash_key: payment1.hash_key},{hash_key: payment2.hash_key}]}
      ...
      it "delete the period data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, period_table: [{hash_key: period1.hash_key},{hash_key: period2.hash_key}]}
      ...
      it "delete the pref data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, pref_table: [{key: pref1.key},{key: pref2.key}]}
      ...
      it "delete the project data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, project_table: [{hash_key: project1.hash_key},{hash_key: project2.hash_key}]}
      ...
      it "delete the subcategory data" do
        ...
        post :delete_all, body: {user: user1.email, device: device.uuid, subcategory_table: [{hash_key: subcategory1.hash_key},{hash_key: subcategory2.hash_key}]}
