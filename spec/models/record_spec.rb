...
describe Record do
	before do
		@record = Record.new( mount: 0, category: 'fdWS92Sv3d9iSiSd3H7INg', subcategory: 'gB9O7LgZjh1Qe7T0pQVKBw',
	...
	it "is valid with mount, category, subcategory, date, currency_code, amount_to_main, user_id, hash_key and in_payment (or out_payment)." do
		expect(@record).to be_valid
	end

	it "is valid with mount, category, subcategory, date, currency_code, amount_to_main, user_id, hash_key and out_payment (or in_payment)." do
	...
	it "is invalid without a subcategory."
